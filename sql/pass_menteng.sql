...
CREATE TABLE `blacklist` (
  ...
  `tamu_type` enum('penghuni','engineering','kilat') DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `jadwal_hari_ini` (`id`, `nama`, `unit`, `jam`, `tujuan`, `status`, `progres`) VALUES
(1, 'Anindya', '1203', '08:00:00', 'Perbaikan', 'Selesai', 100),
(2, 'Rizky', '1102', '09:30:00', 'Pengecekan Listrik', 'Sedang Dikerjakan', 50);
...
INSERT INTO `kunjungan` (`id`, `id_izin`, `waktu_masuk`, `waktu_keluar`, `foto_masuk`, `foto_keluar`, `qr_code`, `jenis_izin`, `status`, `deleted_at`) VALUES
(2, 2, '2025-06-05 12:10:00', '2025-06-05 15:30:00', 'foto_masuk_2.jpg', 'foto_keluar_2.jpg', 'QR002', 'engineering', 'pending', NULL),
(3, 7, '2025-06-02 10:05:00', NULL, 'foto_masuk_3.jpg', NULL, 'QR003', 'penghuni', 'pending', NULL);
...
INSERT INTO `laporan_masalah` (`id`, `tanggal`, `teknisi`, `laporan`, `waktu`, `status`, `progres`, `tanggal_tindak_lanjut`) VALUES
(1, '2025-05-23', 'Budi', 'AC Bocor', '10:00:00', 'baru', 0, NULL),
(2, '2025-05-24', 'Andi', 'Lampu Mati di Kamar Mandi', '14:00:00', 'baru', 0, NULL),
(3, '2025-06-06', '', 'kebocoran sink di unit 203', '17:30:00', 'baru', 0, '2025-06-09');
...
INSERT INTO `notifikasi` (`id`, `id_user`, `message`, `status`, `created_at`) VALUES
(1, 1, 'Tamu Anda Doni Saputra sudah masuk.', 'unread', '2025-05-26 15:29:21'),
(2, 1, 'Jadwal periksa AC hari ini jam 14:00.', 'unread', '2025-05-26 15:29:21');
...
INSERT INTO `tamu` (`id`, `nama_tamu`, `no_identitas`, `no_hp`, `jenis_kelamin`, `tujuan`, `alamat`, `status`, `foto_ktp`, `created_at`, `waktu_checkin`, `id_penghuni`) VALUES
(12, 'pt mandala teknologi utama', '3275091208970003', '080808080808', 'L', 'Engineering', 'ciputat', 'checkedout', NULL, '2025-06-01 04:06:53', '2025-06-01 18:06:53', NULL),
(13, 'Arief Nur Ramadhan', '3273032209000005', '+628207877612', 'L', 'cendana 12', 'Cibubur', 'pending', 'ktp_6847ce274c262.jpeg', '2025-06-10 06:18:15', '2025-06-10 13:18:15', NULL),
(14, 'Kevin Maulana', '3275031205960011', '0813-2299-8833', 'L', 'engineering', 'Cilandak', 'pending', NULL, '2025-06-11 06:28:39', '2025-06-11 13:28:39', NULL),
(23, 'Nur Azizah', '3273031602030012', '+628207877612', 'P', 'Tower Tanjung 1111', 'Cibinong', 'Pending', 'ktp_6849508f77f23.jpeg', '2025-06-11 09:46:55', '2025-06-11 16:46:55', NULL);
...
INSERT INTO `tamu_kilat` (`id`, `nama_pengantar`, `nik`, `layanan`, `tujuan_unit`, `waktu_masuk`, `foto_ktp`, `qr_code_data`, `status`) VALUES
(1, 'DANURENDRA TEN AGASTHA', '1234567891011121', 'Gojek', 'tower palem 1507', '2025-06-01 14:10:40', 'ktp_683bfcf021141.jpeg', NULL, 'menunggu');
...
--
-- Constraints for table `panic_logs`
--
ALTER TABLE `panic_logs`
  ADD CONSTRAINT `panic_logs_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `tamu_users` (`id`) ON DELETE CASCADE;
COMMIT;
