...
$sqlTamu = "SELECT 
    ...
    no_hp,
    alamat,
    'Unit A-01' AS unit -- Ganti dengan kolom unit asli jika ada
FROM tamu";
...
<div class="d-flex">
    ...
    <div class="flex-grow-1 p-4">
        ...
        <div class="no-print mb-4 d-flex justify-content-between align-items-center">
            <h4>Tamu Masih Berada di Lokasi</h4>
            <div>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <?php else: ?>
                    <tr>
                        <td colspan="5" class="text-center">Tidak ada tamu yang masih berada di lokasi saat ini.</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
